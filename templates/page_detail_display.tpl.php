...
<?php if ($display == 'full'): ?>
  ...
  <?php else: ?>
    ...
    <h2><?php ($doc[0]->authLastNameFirstName_s) ? print t("AUTHORS") : print '' ?></h2>
    ...
    <h2><?php ($doc[0]->abstract_s || $doc[0]->en_abstract_s) ? print t("ABSTRACT") : print ''; ?></h2>
    ...
    <?php if ($doc[0]->fileMain_s): ?>
      ...
      <a class="doc-file" href="<?php print($doc[0]->fileMain_s) ?>"> <img
                src="/<?php print drupal_get_path('module', 'amu_hal') . "/images/doc_file.png" ?>"/>
      </a>
    <?php endif; ?>
    ...
    <?php if ($doc[0]->uri_s): ?>
      <p class="doc-more-info">
        <a class="more"
           href="<?php print $doc[0]->uri_s; ?>"><?php print(t("More information")) ?></a>
      </p>
    <?php endif; ?>
